  ...
  <div class="c-wrap">
    <div class="c-split">
      <div class="c-prose">
        ...
        <p>
          CHIRAL is the research arm of the DeepBio ecosystem, alongside DeepBio
          Limited and DeepBio Academy. It is led by a Director, organised into
          units under Group Leaders, and run against written policies covering
          recruitment, authorship, data governance and conduct — all of them
          public. See <a href="/governance/">governance &amp; accountability</a>.
        </p>
        <p>
      ...
      <div class="c-aside">
        <dl class="c-facts">
          ...
          <dt>Based in</dt>
          <dd>Dhaka, Bangladesh. Virtual HQ — no physical premises.</dd>

          <dt>Model</dt>
          <dd>Volunteer-run and non-profit, distributed by default. No fees charged, no stipends paid.</dd>
