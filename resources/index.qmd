---
pagetitle: "Learning resources | CHIRAL Bangladesh"
description: "Databases, tools and set-up guides we teach against and use in our own analyses."
page-layout: custom
toc: true
toc-location: right
listing:
...
<h1>Learning resources</h1>
    <p>
      The public databases, tools and set-up steps our courses are built on.
...
<section class="c-slab c-slab--paper">
  <div class="c-wrap">
    <div class="c-slab-head">
      <span class="c-eyebrow">Video lectures</span>
      <h2 class="c-h2">Recorded course playlists</h2>
      <p class="c-lede">
...
<section class="c-slab c-slab--white">
  <div class="c-wrap">
    <div class="c-slab-head">
      <span class="c-eyebrow">Pipelines</span>
      <h2 class="c-h2">Reusable analysis workflows</h2>
      <p class="c-lede">
        Working pipelines from our own projects, with the inputs they expect and
        the outputs they produce stated up front.
      </p>
    </div>
```
